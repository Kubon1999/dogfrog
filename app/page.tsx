	...
	return (
		<main className="min-h-screen ">
			...
			<div className="text-center fixed bottom-10 left-0 right-0 font-mono uppercase text-[11px] font-semibold">
				...
				<p className="mt-4 opacity-40 text-[6px]">
					This is a fan-run website and not affiliated with the official TikTok profile.
					<br></br>By engaging with $ivy, a meme token on Pump.funs Solana platform, you agree to this Disclaimer. $ivy is for entertainment purposes only and has no utility or guaranteed value. It is highly speculative and extremely volatile.
					<br></br>The $ivy family receives 0.05% to 0.95% per trade on PumpSwap.
					<br></br>This is not financial or legal advice. Always consult qualified professionals before making decisions. The Creator and the family are not advisors and are not liable for any losses.
					<br></br>Verify all details directly at pump.fun or x.com.If you do not fully understand the risks, please do not engage.Proceed with caution.
				</p>
			</div>
		</main>
	);
